        ...
        <div className="bg-[#E7F4EA]">
            <div className='max-w-screen-xl mx-auto'>
                <div className="header-bg bg-fixed">
                    <div className="h-screen text-center w-full md:w-2/3 px-4 md:mx-auto pt-20">
                        ...
                        <p className="text-white my-4 w-full md:w-2/3 md:mx-auto">Lorem ipsum dolor sit amet consectetur adipisicing elit. Minima enim dolores recusandae tenetur reiciendis aut esse quos excepturi laboriosam amet?</p>
